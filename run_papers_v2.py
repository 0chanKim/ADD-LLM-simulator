"""
run_papers_v2.py --- Multi-paper accelerator energy/performance comparison (v2)

Same as run_papers.py, but uses systolic_array_synth_papers_2.csv:
  - addllm_s updated to add_moe_core_32_v2 DC results (Samsung 28nm SS)
    area: 863 um^2/PE (883734.67 um^2 total / 1024 PE)
    dynamic: 293117 nW/PE (300.152 mW total / 1024 PE)
...
# --- Write results CSV ---
res_csv_path = os.path.join(results_dir, 'papers_v2_res.csv')
