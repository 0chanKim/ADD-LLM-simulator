"""
EnergyAll_papers.py --- Visualization for multi-paper accelerator comparison

Generates:
  - fig_papers.pdf:
      Top chart:    Power Efficiency (higher = better, baseline W4A16 = 1.00)
      Bottom chart: Normalized TOPS/Area (higher = better)
  - Both charts sorted ascending (left->right), Ours always rightmost
  - Baseline: W4A16
"""
...
# All accelerators in CSV order (must match run_papers.py display_order)
...
def load_papers_data():
    """Load energy data from papers_res.csv"""
...
output_path = './results/fig_papers.pdf'
